...
<header>
    ...
    <nav id="navMenu">
        <div class="nav-wrapper container">
            <a href="#!" class="brand-logo container"><img class="responsive-img" src="imagens/logo.png"
                                                           alt="LogoSite"/></a>
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <!-- Dropdown Trigger -->
                <li><a class="dropdown-trigger" href="#!" data-target="dropdown1">Algoritmos<i
    ...
    <ul class="sidenav" id="mobile-demo">
        <li><a href="index.jsp">Home</a></li>
        <li><a href="sobre.jsp">Sobre</a></li>
        <li><a class="dropdown-trigger" href="#!" data-target="dropdown2">Algoritmos<i class="material-icons right">arrow_drop_down</i></a>
        </li>
    </ul>
    ...
    <div class="col s12 m12 l8">
        ...
        <form action="Servlet_interpolacao" method="get" class="form">
            ...
            <div class="col s12 container">
                ...
                <button class="btn waves-effect red darken-3 col s5 m3 l4" type="submit" name="action">Submit
                    <i class="material-icons right">send</i>
                </button>
                <a class="btn waves-effect red darken-3 col s5 m3 l4 offset-s1 offset-m1 offset-l1" href="index.jsp"
                   name="action">Voltar
    ...
    <div class="container">
        <div class="row">
            <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">Site desenvolvido sem fins lucrativos, para atender aqueles que
                    precisam.</p>
            </div>
